...
Hombrechtikon 2026-04-07

#v(0.5cm)

*Rechnung* \
Lieferadresse: Thomas Sjøberg, C/o Hotel Waldstätterhof Lucerne, Zentralstrasse 4, 6003 Lucerne
...
#table(
  ...
  [www.klangspiel.ch/trinkente_gross_pink],
  [1 #h(2em) 36.20],
  [36.20],
...
#page(paper: "a5", flipped: true, margin: (left: 1cm, top: 2cm, right: 1cm, bottom: 2cm))[
	...
	#pad(left: 8cm, top: 6cm)[
		#text(size: 24pt, weight: "bold")[
			  \
			Thomas Sjøberg \
			C/o Hotel Waldstätterhof Lucerne	Zentralstrasse 4 \
			6003 Lucerne
		]  
	]
]
