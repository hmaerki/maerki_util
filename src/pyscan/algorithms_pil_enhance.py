...
def enhance(strFilenameBMP, filenameSaveAs, fPercentageBlack=0.01, iDpi=300):
    ...
    if False:
        ...
        rgb2xyz = (0.112453, 0.357580, 0.180423, 0,
            0.112671, 0.715160, 0.072169, 0,
            0.019334, 0.119193, 0.950227, 0)
...
def enhance3(strFilenameBMP, filenameSaveAs, iDpi=300):
  ...
  imgPalette = imGrayBW.convert("P", dither=Image.NONE, palette=Image.ADAPTIVE, colors=4)
...
def enhance5(strFilenameBMP, filenameSaveAs, bVerkleinern=True, iRasterEntfernen=4, bHelligkeitskorrektur=False, iAlphaBW=120, iBlackWhite=180, iDpi=300):
  '''
...
def enhance6(strFilenameBMP, filenameSaveAs, bVerkleinern=True, iRasterEntfernen=4, iAlphaBW=120, iBlackWhite=180, iDpi=300):
  '''
    Diese Optimierung kombiniert enhance3 und enhance4.
  '''
  if False:
